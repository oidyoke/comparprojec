...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filterMap.put("/sys/competitor/downloadExcel", "anon");
        filterMap.put("/sys/competitor/upload", "anon");
        filterMap.put("/sys/controllertable/downloadExcel", "anon");
        filterMap.put("/sys/controllertable/upload", "anon");
        filterMap.put("/**", "authc");
